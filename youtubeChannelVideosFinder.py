...
requestChannelVideosInfo = youtubeSearchApiUrl + 'channelId={0}&part=snippet&order=date&type=video&publishedBefore={1}&publishedAfter={2}&pageToken={3}&maxResults=50'
